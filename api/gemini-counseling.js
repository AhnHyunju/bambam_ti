...
다음 학생 정보와 교사의 고민을 바탕으로 상담 전략을 제안해 주세요.
...
[응답 작성 원칙]
1. 학생을 단정적으로 판단하거나 진단하지 마세요. (예: "의지가 부족하다", "주의력 문제가 있다", "심리적 문제가 있다" 등 단정하는 표현 금지)
2. 교사가 학생을 이해하고 대화할 수 있도록 돕는 방향으로 응답하세요.
3. 아래의 형식을 반드시 지켜서 작성해 주세요. (마크다운 사용 가능)
4. 상담 전략은 참고용이며, 최종 판단은 교사가 한다는 점을 포함해 주세요.
